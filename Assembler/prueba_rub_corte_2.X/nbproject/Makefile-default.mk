...
FINAL_IMAGE=${DISTDIR}/prueba_rub_corte_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/prueba_rub_corte_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F84A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/prueba_rub_corte_2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/prueba_rub_corte_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F84A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/prueba_rub_corte_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
