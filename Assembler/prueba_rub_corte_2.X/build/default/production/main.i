...
; Configuración de los puertos como entradas o salidas
 SETUP:
    ...
    movwf TRISA ;CONFIGURACION DEL PORTA ((PORTA) and 07Fh), 0 Y ((PORTA) and 07Fh), 1 COMO ENTRADAS
    movlw 00000000B
...
; Programa Principal
APAGADO:
    bsf PORTB, 1 ;Colocando en 1 el pin ((PORTB) and 07Fh), 0 del PORTB
    call RETARDO ;Espero
    bcf PORTB, 1 ;Colocando en 0 el pin ((PORTB) and 07Fh), 0 del PORTB
    bsf PORTB, 2
    call RETARDO
    bcf PORTB, 2
    bsf PORTB, 3
